						...
						<table class="table table-bordered table-hover">
							<thead class="bill-header cs">
								<tr>
									...
									<th id="trs-hd" class="col-lg-2" style="width: 300px;"> Description </th>
									<th id="trs-hd" class="col-lg-2" style="width: 300px;">Create Date</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach var="course" items="${listCourse}">
									<tr>
										...
										<td><a href="${pageContext.request.contextPath}/trainee/viewListTrainerRequest?id=${course.courseID}" class="btn btn-success"> View Request </a>
											</td>
									</tr>
								</c:forEach>
