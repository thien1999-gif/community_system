...
<title>Trainer Teaching Course</title>
...
<body class="text-monospace text-nowrap">
					...
					<select id="trainerRequest"
						...
						<optgroup label="Select option">
							<option
								...
								Course</option>
							<option
								value="<c:url value="/trainer/trainer-Manage-TeachingCourse"/>"
								selected="">Teaching Course</option>
							<option
	...
	<div class="container">
		<div role="alert" class="alert alert-light text-center">
			<span style="font-size: 22px;"><strong>Your teaching
					Courses</strong><br /></span>
		</div>
	</div>
	<div class="container">
		<div class="row" style="padding: 30px 0px;">
			<div class="col">
				<form
					class="d-flex d-md-flex justify-content-start justify-content-md-start justify-content-xl-center align-items-xl-center"
					method="post" action="trainer-Manage-TeachingCourse">
					<span> <i
	...
	<c:if test="${not empty teachingCourseList}">
		<div class="container">
			<c:forEach var="list" items="${teachingCourseList}">
				<div
					...
					<table class="table table-striped table-bordered table-sm">
								...
								<th style="height: 50px; margin: 10px 0px;"><span
									...
									<form action="ViewTraineeProfile" method="post">
										<input type="hidden" name="actionName"
											value="trainer-Manage-TeachingCourse"> <input
						...
						<tbody>
							...
							<tr>
								<td colspan="2">
									<form action="EndTeachingCourseAction" method="post">
										<input type="hidden" name="courseID" value="${list.courseID}">
										<input type="hidden" name="subjectID" value="${subjectID}">
										<button class="btn btn-primary float-right" type="submit"
											style="width: 200px; background-color: #dd7500;"
											onclick="return confirm('Are you sure you want to end this course?');">
		...
		<div class="container">
			<form action="trainer-Manage-TeachingCourse" method="post">
	...
	<c:if test="${empty teachingCourseList}">
		<div class="container">
			<div role="alert" class="alert alert-warning">
				<span> <strong>Alert:</strong> No teaching courses can be
					found!
				</span>
			</div>
		</div>
