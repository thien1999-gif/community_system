...
<body class="text-monospace text-nowrap">
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navcol-1">
						<ul class="nav navbar-nav ml-auto">
							<li class="nav-item" role="presentation"><a dis
	...
	<div class="container">
		...
		<div role="alert" class="alert alert-light text-center">
			<span style="font-size: 22px;"><strong>Recommended
		...
		<div class="row" style="padding: 30px 0px;">
			<div class="col">
				<form
					...
					method="post" action="trainer-Home">
					<span> <i
	...
	<c:if test="${not empty traineePostList}">
		<div class="container">
			<c:forEach var="list" items="${traineePostList}">
				<div
					...
					<table class="table table-striped table-bordered table-sm">
							...
							<tr>
								...
								<th style="height: 50px; margin: 10px 0px;"><span
									...
									<form action="ViewTraineeProfile" method="post">
										<input type="hidden" name="actionName" value="trainer-Home">
										<input type="hidden" name="traineeID"
											value="${list.traineeID}"> <input type="hidden"
						...
						<tbody>
							...
							<tr>
								<td colspan="2">
									<form action="RequestTraineeCourseAction" method="post">
										<input type="hidden" name="courseID" value="${list.courseID}">
										<input type="hidden" name="subjectID" value="${subjectID}">
										<button class="btn btn-primary float-right" type="submit"
											style="width: 87.5781px; background-color: #008272;"
											onclick="return confirm('Are you sure you want to request this course?');">
											Request</button>
									</form>
								</td>
							</tr>
	...
	<c:if test="${empty traineePostList}">
		<div class="container">
			<div role="alert" class="alert alert-warning">
				<span> <strong>Alert:</strong> No trainee courses can be
					found!
				</span>
			</div>
		</div>
	...
	<c:if test="${trainer.verify == 0}">
		...
		<div id="pageLoading" class="pageLoading">
			<h1 style="color: red;">Please wait admin verify!!!</h1>
			<br> <a class="btn btn-primary" role="presentation"
				href="<c:url value="/guest/logout" />"> Logout </a>
		</div>
