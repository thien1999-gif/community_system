...
<title>Trainer Request Course</title>
...
<body class="text-monospace text-nowrap">
				...
				<form
					...
					<select id="trainerRequest"
						...
						<optgroup label="Select option">
							<option
								value="<c:url value="/trainer/trainer-Manage-RequestCourse"/>"
								selected="">Requesting Course</option>
							<option
	...
	<div class="container">
		<div role="alert" class="alert alert-light text-center">
			<span style="font-size: 22px;"><strong>Your
					Requesting Courses</strong><br /></span>
		</div>
	</div>
	<div class="container">
		<div
			...
			<div class="col">
				<form
					class="d-flex d-md-flex justify-content-start justify-content-md-start justify-content-xl-center align-items-xl-center"
					method="post" action="trainer-Manage-RequestCourse">
					<span> <i
	...
	<c:if test="${not empty trainerRequestList}">
		<div class="container">
			<c:forEach var="list" items="${trainerRequestList}">
				<div
					...
					<table class="table table-striped table-bordered table-sm">
								...
								<th style="height: 50px; margin: 10px 0px;"><span
									...
									<form action="ViewTraineeProfile" method="post">
										<input type="hidden" name="actionName"
											value="trainer-Manage-RequestCourse"> <input
						...
						<tbody>
							...
							<tr>
								<td colspan="2">
									<form action="CancelTrainerRequestAction" method="post">
										<input type="hidden" name="courseID" value="${list.courseID}">
										<input type="hidden" name="subjectID" value="${subjectID}">
										<button class="btn btn-primary float-right" type="submit"
											style="width: 200px; background-color: #b31c00;"
											onclick="return confirm('Are you sure you want to cancle request?');">
		...
		<div class="container">
			<form action="trainer-Manage-RequestCourse" method="post">
	...
	<c:if test="${empty trainerRequestList}">
		<div class="container">
