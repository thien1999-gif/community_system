			...
			<div class="container">
				<div class="col-md-12 search-table-col"
					...
					<div
						...
						<form action="deleteAllPost">
							<font style="color: red">${message}</font>
							<table class="table table-bordered table-hover">
								<thead class="bill-header cs">
									<tr>
										<th id="trs-hd" class="col-lg-1" style="width: 50px;">Check
											to Delete</th>
										<th id="trs-hd" class="col-lg-1" style="width: 400px;">Title</th>
										<th id="trs-hd" class="col-lg-2" style="width: 300px;">
											Description</th>
										<th id="trs-hd" class="col-lg-2" style="width: 300px;">Create
											Date</th>
										<th id="trs-hd" class="col-lg-2" style="width: 300px;">Detail</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach var="course" items="${listCourse}">
										<tr>
											<td><input type="checkbox" value="${course.courseID}"
												name="courseID" /></td>
											<td>${course.title}</td>
											...
											<td><a
												href="${pageContext.request.contextPath}/admin/CourseDetail?id=${course.courseID}"
							...
							<button class="btn btn-primary" type="submit">Deny by checkbox</button>
						</form>
