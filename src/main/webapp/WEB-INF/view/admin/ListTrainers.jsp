			...
			<div class="container">
				...
				<div class="col-md-12 search-table-col"
					...
					<div class="form-group pull-right col-lg-4">
						<form action="searchTrainerByEmail" method="POST">
							...
							<input type="text" placeholder="Search by name typing here.."
								class="search form-control" name="searchName">
						</form>
					</div>
					...
					<c:url value="/admin/ListTrainers" var="pagedLink">
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<c:remove var="trainer" />
								<c:if test="${!listTrainer.isEmpty()}">
									<c:forEach var="trainer" items="${pagedListHolder.pageList}">
										...
										<tr>
											...
											<td><a
												href="${pageContext.request.contextPath}/admin/detailTrainer?id=${trainer.email}"
