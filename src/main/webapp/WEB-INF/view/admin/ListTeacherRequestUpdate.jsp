	...
	<main class="page projects-page">
		<section class="portfolio-block projects-cards">
			<h1
				...
				LIST OF TEACHER REQUEST UPDATE</h1>
			<div class="container">
						...
						<table class="table table-bordered table-hover">
							<thead class="bill-header cs">
								<tr>
									...
									<th id="trs-hd" class="col-lg-2" style="width: 300px;">CV
										Link</th>
							...
							<tbody>
								<c:forEach var="trainer" items="${listTrainer}">
									<tr>
										...
										<td><a
											href="${pageContext.request.contextPath}/admin/TeacherUpdateRequest?id=${trainer.email}"
											class="btn btn-success"> Detail </a> <!-- 											<button class="btn btn-danger" type="submit" -->
