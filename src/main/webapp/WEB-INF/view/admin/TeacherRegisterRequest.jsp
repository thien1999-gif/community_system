	...
	<main class="page hire-me-page">
		...
		<section class="portfolio-block hire-me">
			...
			<div class="container" style="margin: 50px auto; text-align: center;">
				<div class="heading">
					<h2>TEACHER &nbsp;REGISTER PROFILE</h2>
				</div>
				...
				<form:form
					...
					method="POST" action="" commandName="trainer">
					<div class="form-group">
						<label for="email">Email</label>
						<form:input readonly="true" class="form-control" path="email" type="email"
							id="email" />
					</div>
					<div class="form-group">
...
<%-- 								<option value="1" ${traineeProfile.gender == 1? 'selected':'disabled' }>Male</option> --%>
<%-- 								<option value="2" ${traineeProfile.gender == 2? 'selected':'disabled' }>FeMale</option> --%>
<!-- 							</optgroup> -->
<%-- 						</form:select> --%>

							<input type="text" readonly class="form-control" value="${trainer.gender == 1? 'Male':'Female' }" />
						<form:input readonly="true" class="form-control" path="gender" type="hidden" />
						</td>
					...
					<div class="form-group">
						<label for="message">Granduation year</label>
					...
					<div class="form-group">
						...
						<form:textarea class="form-control"  readonly="true" style="width:100%" name="" id="" cols="30"
							rows="10" path="description"></form:textarea>
					</div>


					<div class="form-group">
						<label for="message">Salary per hour</label>
						<form:input readonly="true" path="salaryPerHour" class="form-control" type="text" />
					</div>
					<div class="form-group">
						<label for="message">Facebook</label>
						<form:input readonly="true" class="form-control" path="facebook" type="text" />
					</div>

					<div class="form-group">
						<label for="message">Zalo</label>
					...
					<div class="form-group">
						<label for="message">In front of ID card </label> <img
							src="<c:url value="${frontIdCard}" />"
							style="margin: 50px auto; min-width: 200px; min-height: 200px; width: 100%; height: 100px;">
					</div>
					<div class="form-group">
						<label for="message">Behind ID card</label> <img
							src="<c:url value="${behindIdCard}" />"
							style="margin: 50px auto; min-width: 200px; min-height: 200px; width: 100%; height: 100px;">
					</div>
					...
					<div class="btn-group" role="group">
						<input type="hidden" class="form-control" name="idCard"
							value="${trainer.idCard}" type="text" /> <input type="hidden"
							class="form-control" name="resumeLink"
							value="${trainer.resumeLink}" type="text" /> <input
							type="hidden" name="avatar" value="${trainer.avatar}" />
							<input type="hidden" name="longitude" value="${trainer.longitude}" />
							<input type="hidden" name="latitude" value="${trainer.latitude}" />

						<button class="btn btn-primary" type="submit"
							style="background-color: rgb(31, 239, 13);">Accept</button>
						...
						<a class="btn btn-primary"
							href="${pageContext.request.contextPath}/admin/DenyRegisterRequest?id=${trainer.email}"
							style="background-color: firebrick">Deny</a> <a
							class="btn btn-primary"
							href="${pageContext.request.contextPath}/admin/ListTeacherRequest"
							style="background-color: firebrick">Cancel</a>
					</div>
				</form:form>
			</div>
		</section>
